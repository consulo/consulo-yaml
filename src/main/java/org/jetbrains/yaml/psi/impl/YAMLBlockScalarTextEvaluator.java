...
import static org.jetbrains.yaml.psi.impl.YAMLBlockScalarImpl.isEol;

public abstract class YAMLBlockScalarTextEvaluator<T extends YAMLBlockScalarImpl> extends YamlScalarTextEvaluator<T> {

    public YAMLBlockScalarTextEvaluator(@Nonnull T host) {
        super(host);
    }
     ...
     */
    protected final @Nonnull ChompingIndicator getChompingIndicator() {
