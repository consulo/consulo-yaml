...
public class YAMLBlockMappingImpl extends YAMLMappingImpl {
    ...
    public @Nonnull YAMLKeyValue getFirstKeyValue() {
    ...
    private void addNewKeyToTheEnd(@Nonnull YAMLKeyValue key) {
     ...
     */
    public void insertKeyValueAtOffset(@Nonnull YAMLKeyValue keyValue, int offset) {
     ...
     */
    public @Nullable YAMLKeyValue getOrCreateKeySequence(@Nonnull List<String> keyComponents, int preferableOffset) {
