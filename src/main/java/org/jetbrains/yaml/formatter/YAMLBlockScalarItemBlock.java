...
final class YAMLBlockScalarItemBlock implements Block {
  final @Nonnull TextRange myRange;
  final @Nullable Indent myIndent;
  final @Nullable Alignment myAlignment;

  private YAMLBlockScalarItemBlock(@Nonnull TextRange range, @Nullable Indent indent, @Nullable Alignment alignment) {
    myRange = range;
    myIndent = indent;
  ...
  static @Nonnull Block createBlockScalarItem(@Nonnull YAMLFormattingContext context, @Nonnull ASTNode node) {
  ...
  private static int getFirstLineOffset(@Nonnull YAMLFormattingContext context, @Nonnull YAMLBlockScalarImpl blockScalarPsi) {
  ...
  private static int getParentFullIndent(@Nonnull YAMLFormattingContext context, @Nonnull ASTNode node) {
  ...
  private static int getNodeFullIndent(@Nonnull ASTNode node) {
